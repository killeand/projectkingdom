...
export default function Layout({ children }) {
    ...
    return (
        <>
            ...
            <header className="flex flex-col md:flex-row items-center bg-black">
                <Link href="/" className="flex flex-row w-full md:w-fit items-center justify-center">
                    <div className="p-3 w-full md:w-fit" style={{ backgroundImage: "url(/ProjectKingdomLogo.jpg)" }}>
                ...
                {session && (
                    <div className="flex flex-row items-center px-2">
                        ...
                        <div className="flex flex-col">
                            ...
                            <button className="btn btn-xs btn-info" onClick={signOut}>Sign Out</button>
                        </div>
                    </div>
                )}
